...
public class TheGuard {
    public static void main(String[] args) {
        ...
        if(playerClass == 1 && playerChoice == 1){
        	...
        	System.out.println("You sneakily convince the guard to move on to a different location");
        }
        ...
        }else {System.out.println("Your attempt fails and the guard punches you");
